...
const destWidgetSrcFolder = "components/";
    ...
    _writeWidgetFiles() {
        ...
        if (this.widget.usesEmptyTemplate) {
            this._copyTemplate(
                ...
                `${destWidgetSrcFolder}HelloWorld${tempSampleSuffix}.${fileExtension}`
            );
            this._copyTemplate(
            ...
            this._copyTemplate(
                ...
                `${destWidgetSrcFolder}Badge${tempSampleSuffix}.${fileExtension}`
            );
            this._copyTemplate(
                `${this.widget.templateSourcePath}src/WidgetName.${fileExtension}.ejs`,
                `${this.widget.name}.${fileExtension}`
            ...
            if (this.widget.isPlatformWeb) {
                ...
                if (this.widget.usesFullTemplate) {
                    this._copyFile(
                        ...
                        `${destWidgetSrcFolder}/__tests__/Badge.spec.${fileExtension}`
                    );
                } else {
                    this._copyFile(
                        `${this.widget.templateSourcePath}${widgetSrcFolder}/__tests__/HelloWorld.spec.${fileExtension}.ejs`,
                        `${destWidgetSrcFolder}/__tests__/HelloWorld.spec.${fileExtension}`
                    );
                }
            }
        }
